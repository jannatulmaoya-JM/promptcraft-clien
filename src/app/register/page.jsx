      ...
      <div className="max-w-sm w-full bg-white p-6 rounded-2xl shadow-xl border border-gray-100">
        ...
        <form onSubmit={handleRegister} className="space-y-5">
          ...
          <div>
            ...
            <input type="url" name="image" required placeholder="https://example.com/avatar.jpg" className="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:border-blue-500 text-sm text-gray-900" />
          </div>
          <div>
