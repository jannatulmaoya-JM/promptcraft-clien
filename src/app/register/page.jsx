...
//     const role = formData.get("role"); // ড্রপডাউন থেকে ভ্যালু আসছে
...
//               name="role" 
//               required
//               className="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:border-blue-500 text-sm text-gray-900 bg-white"
//             >
